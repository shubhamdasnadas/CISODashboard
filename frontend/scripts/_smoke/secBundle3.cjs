...
// src/pages/report/_RTTest.jsx
var RTTest_exports = {};
__export(RTTest_exports, {
  AgentAnalytics: () => AgentAnalytics,
  AppInsightsSection: () => AppInsightsSection,
  AtRiskSection: () => AtRiskSection,
  ...
  ZohoSection: () => ZohoSection,
  default: () => ReportTemplate
});
module.exports = __toCommonJS(RTTest_exports);
...
function buildFirewallSummary({
  ...
  const topDestRows = attackerDestTable?.rows?.length ? attackerDestTable.rows : riskRows;
  const topDestEntry = makeTopChartData(topDestRows, topDestCols)[0];
  const topDestination = topDestEntry?.name || "-";
  const topConnections = connTable ? makeTopChartData(connTable.rows, ["name", "src", "source", "dst", "destination"]) : [];
  return {
    riskTable,
    attackersTable,
    attackerDestTable,
...
function CheckpointSection({ events, weekly, mttr }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: S.row2, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HBarBlock, { title: "Most Targeted Mailboxes", data: topTargets, color: "#8b5cf6", half: true, desc: "Recipients most frequently targeted" }) })
  ] });
}
...
function ZohoSection({ tickets, mttr }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.row2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: S.chartHalf, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MttrGaugeCard, { cfgKey: "ticketing", mttr }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.chartHalf, children: [
...
function FirewallSection({ fw }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.kpiRow, wrap: false, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Total Traffic", value: formatBytes(f.totalTraffic), color: "#06b6d4" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Top Destination", value: f.topDestination || "-", color: C.green })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.row2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DonutBlock, { title: "Risk Distribution", data: riskDist, half: true }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.chartHalf, wrap: false, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.chartHalfTitle, children: "Risk / Session Trend" }),
        f.riskTrend.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VLineChart, { data: f.riskTrend, width: 320, height: 150, labelKey: "date", valueKey: "sessions", stroke: C.red }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(EmptyNote, {})
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.row2, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.row2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HBarBlock, { title: "Top Denied Destinations", data: f.topDeniedDestinations, color: "#ef4444", half: true }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HBarBlock, { title: "Top Connections", data: f.topConnections, color: "#10b981", half: true })
    ] })
  ] });
}
