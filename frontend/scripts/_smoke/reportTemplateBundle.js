...
function computeWeeklyStats(harmonyEvents, s1Threats, s1Agents = [], s1Cves = []) {
  ...
  thisWeekEvents.forEach((e) => {
    const s = e.sender_address || "Unknown";
    sThis[s] = (sThis[s] || 0) + 1;
  });
...
function buildThreatAnalytics(threats) {
  ...
  const engineData = byCount((x) => (x.threatInfo?.engines || []).map((e) => typeof e === "string" ? e : e?.name || "Unknown").join("|")).slice(0, 10).map((d) => ({ ...d, name: d.name.includes("|") ? d.name.split("|")[0] : d.name }));
  const tacticData = byCount((x) => (x.indicators || []).map((i) => (i.tactics || []).map((tc) => tc.name).join("|")).join("|")).slice(0, 12).map((d) => ({ ...d, name: d.name.includes("|") ? d.name.split("|")[0] : d.name }));
...
function VDonut({ data, width = 180, height = 150, thickness = 22, colors }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_renderer.Svg, { width, height, viewBox: `0 0 ${width} ${height}`, children: [
    segments,
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_renderer.Circle, { cx, cy, r: (innerR + r) / 2, fill: "transparent" })
  ] });
}
...
function PdfTable({ columns, rows, widths, strip = true, maxRows = 20 }) {
  const display = (rows || []).slice(0, maxRows);
  if (!columns || columns.length === 0 || display.length === 0) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { wrap: false, style: { marginBottom: 4 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: { flexDirection: "row", backgroundColor: C.bg, borderBottomWidth: 1, borderBottomColor: C.line, paddingVertical: 4 }, children: columns.map((c) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: { flex: 1, paddingHorizontal: 6, fontSize: 7.5, fontWeight: 700, color: C.muted, textTransform: "uppercase", letterSpacing: 0.4 }, children: c }, c)) }),
    display.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: { flexDirection: "row", backgroundColor: strip && i % 2 === 1 ? "#fafafa" : "#fff", borderBottomWidth: 1, borderBottomColor: "#f3f4f6", paddingVertical: 3 }, children: columns.map((c, ci) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: { flex: 1, paddingHorizontal: 6, fontSize: 8, color: C.ink, fontWeight: ci === 0 ? 600 : 400 }, children: String(r[c] ?? "-") }, c)) }, i))
  ] });
}
function ChartFrame({ title, children, desc }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, wrap: false, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: title }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: S.chartFrame, children }),
...
function PageFooter({ orgName, generatedAt }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.footer, fixed: true, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { children: date })
  ] });
}
...
function ExecutiveSummary({ d, weekly }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.kpiRow, wrap: false, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Security Score", value: `${risk.securityScore}/100`, sub: scoreStatus.label, color: scoreStatus.color }),
...
function CheckpointSection({ events, weekly }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Event State Breakdown" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["State", "Events"], rows: stateRows })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Severity Mix" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: { flexDirection: "row", alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VDonut, { data: sevRows.map((d, i) => ({ ...d, fill: SEV_COLORS[i % SEV_COLORS.length] })), width: 150, height: 140 }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: { flex: 1, marginLeft: 16 }, children: sevRows.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: { flexDirection: "row", alignItems: "center", marginBottom: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.View, { style: { width: 8, height: 8, borderRadius: 2, backgroundColor: SEV_COLORS[i % SEV_COLORS.length], marginRight: 6 } }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Text, { style: { fontSize: 8.5, color: C.sub }, children: [
            d.name,
            " \u2014 ",
            d.value
          ] })
    ...
    weekly && weekly.topSenders.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Senders \u2014 Week-over-Week" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Sender", "This Week", "Last Week", "Change"], rows: weekly.topSenders.slice(0, 10) })
    ] }),
    weekly && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Event Volume \u2014 This Week vs Last Week" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VBarChart, { data: weekly.remComp.map((r) => ({ name: r.day, value: r["This Week"] })), color: C.brand, width: 300, height: 150 })
    ] })
  ] });
}
function ThreatAnalytics({ threats }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SectionDivider, { number: "3", title: "SentinelOne \u2014 Threat Analytics", color: "#dc2626" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Text, { style: S.lead, children: [
      t.total,
      " threats detected. ",
      t.mitigated,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.kpiRow, wrap: false, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Avg MTTM", value: t.avgMttm !== null ? `${Math.round(t.avgMttm)}m` : "N/A", color: C.slate })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Mitigation Status" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Status", "Count"], rows: t.mitigationData, maxRows: 8 })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Classification" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Classification", "Count"], rows: t.classData, maxRows: 8 })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Detection Engines" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Engine", "Count"], rows: t.engineData.slice(0, 8) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "MITRE ATT&CK Tactics" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Tactic", "Count"], rows: t.tacticData.slice(0, 8) })
    ] })
  ] });
}
function AgentAnalytics({ agents, generatedAt, removed }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SectionDivider, { number: "3", title: "SentinelOne \u2014 Agent Analytics", color: "#0ea5e9" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Text, { style: S.lead, children: [
      a.total,
      " agents registered. ",
      a.connected,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.kpiRow, wrap: false, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Total Agents", value: formatNumber(a.total), color: C.sky }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Connected", value: formatNumber(a.connected), color: C.green }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Disconnected", value: formatNumber(a.disconnected), color: C.red }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "New (30d)", value: formatNumber(a.newAgents), color: C.violet }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KpiTile, { label: "Removed", value: formatNumber(removed ?? 0), color: C.slate })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Operating System Distribution" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["OS", "Agents"], rows: a.osData })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Machine Types" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Type", "Agents"], rows: a.machineTypeData })
    ] }),
    agentRows.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Recent Agents" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Name", "OS", "Status", "Version"], rows: agentRows })
    ] })
  ] });
}
function AtRiskSection({ threats }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SectionDivider, { number: "3", title: "SentinelOne \u2014 Most At-Risk Entities", color: "#d97706" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Ranked Devices" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Device", "Threats"], rows: a.devices.slice(0, 8) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Ranked Users" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["User", "Threats"], rows: a.users.slice(0, 8) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Ranked Groups" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Group", "Threats"], rows: a.groups.slice(0, 8) })
    ] })
  ] });
}
function CveSection({ cves }) {
  ...
  if (d.totalApplications === 0) return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SectionDivider, { number: "3", title: "SentinelOne \u2014 Application CVEs", color: "#7c3aed" }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Severity Distribution" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VDonut, { data: d.severityDistribution.map((x) => ({ ...x, fill: CVE_COLORS[x.name] })), width: 150, height: 140 })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Risky Applications" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Application", "CVEs", "Max Score"], rows: d.topRiskyApps.slice(0, 10).map((x) => ({ "Application": x.name, "CVEs": x.cves, "Max Score": Number(x.score).toFixed(1) })) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "CVE Aging" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Age (days)", "Count"], rows: d.cveAging.map((x) => ({ "Age (days)": x.name, "Count": x.count })) })
    ] }),
    d.severityDistribution.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "CVE Exposure Funnel" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Severity", "CVEs", "Endpoints", "Fleet %"], rows: d.severityDistribution.map((x) => ({
        "Severity": x.name,
        "CVEs": x.value,
    ...
    d.criticalApps.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Critical Applications" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Application", "CVEs", "Score", "Endpoints"], rows: d.criticalApps.map((x) => ({
        "Application": x.name,
        "CVEs": x.cveCount,
        "Score": Number(x.highestNvdBaseScore).toFixed(1),
        "Endpoints": x.endpointCount
      })) })
    ] })
  ] });
}
function AppInsightsSection({ apps }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SectionDivider, { number: "3", title: "SentinelOne \u2014 Application Insights", color: "#0ea5e9" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.kpiRow, wrap: false, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "By Operating System" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["OS", "Records"], rows: osRows })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "By Severity" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Severity", "Records"], rows: sevRows })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Installed Applications" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Application", "Installs"], rows: appRows })
    ] })
  ] });
}
function ZohoSection({ tickets }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "By Status" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Status", "Tickets"], rows: z.statusData })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "By Priority" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Priority", "Tickets"], rows: z.priorityData })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Resolution Time Aging" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Age", "Tickets"], rows: z.agingData })
    ] }),
    z.engineerPerformance.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Engineer Performance" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Engineer", "Open", "Closed"], rows: z.engineerPerformance })
    ] }),
    recent.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Recent Tickets" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Subject", "Status", "Priority", "Contact", "Created"], rows: recent })
    ] })
  ] });
}
function FirewallSection({ fw }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    f.riskDistribution.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Risk Distribution" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Risk Level", "Events"], rows: f.riskDistribution.map((x) => ({ "Risk Level": x.name, "Events": x.value })) })
    ] }),
    f.riskTrend.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Risk/Session Trend" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VLineChart, { data: f.riskTrend, width: 300, height: 130, labelKey: "date", valueKey: "sessions" })
    ] }),
    f.topAttacks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Attacks" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Attack", "Count"], rows: f.topAttacks })
    ] }),
    f.topAttackers.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Attacker Sources" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Source", "Count"], rows: f.topAttackers })
    ] }),
    f.riskyUsers.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Risky Users" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["User", "Count"], rows: f.riskyUsers })
    ] })
  ] });
}
function WeeklyInsights({ weekly, d }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    weekly.newVsRecurring.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Threat Recurrence" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Type", "Count"], rows: weekly.newVsRecurring.map((x) => ({ "Type": x.name, "Count": x.value })) })
    ] }),
    weekly.topEndpoints.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Endpoints by Threats" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["Endpoint", "This Week", "Last Week"], rows: weekly.topEndpoints })
    ] }),
    weekly.topUsers.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.block, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_renderer2.Text, { style: S.cardTitle, children: "Top Users by Threats" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PdfTable, { columns: ["User", "This Week", "Last Week"], rows: weekly.topUsers })
    ] })
  ] });
}
function ReportTemplate({ data }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    import_renderer2.Document,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Page, { size: "A4", style: S.page, wrap: true, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Page, { size: "A4", style: S.page, wrap: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PageFooter, { orgName: data.orgName, generatedAt: data.generatedAt }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CheckpointSection, { events: data.harmonyEvents, weekly })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Page, { size: "A4", style: S.page, wrap: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PageFooter, { orgName: data.orgName, generatedAt: data.generatedAt }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ThreatAnalytics, { threats: data.s1Threats })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Page, { size: "A4", style: S.page, wrap: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PageFooter, { orgName: data.orgName, generatedAt: data.generatedAt }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Page, { size: "A4", style: S.page, wrap: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PageFooter, { orgName: data.orgName, generatedAt: data.generatedAt }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ZohoSection, { tickets: data.zohoTickets })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.Page, { size: "A4", style: S.page, wrap: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PageFooter, { orgName: data.orgName, generatedAt: data.generatedAt }),
