...
function CoverPage({ orgName, generatedAt }) {
  ...
  const index = [
    ...
    ["3", "SentinelOne \u2014 Threat Analytics"],
    ["4", "SentinelOne \u2014 Agent Analytics"],
    ["5", "SentinelOne \u2014 Most At-Risk Entities"],
    ["6", "SentinelOne \u2014 Application CVEs"],
    ["7", "SentinelOne \u2014 Application Insights"],
    ["8", "Zoho Desk \u2014 Support Tickets"],
    ["9", "Palo Alto Firewall \u2014 Network Security"],
    ["10", "Weekly Insights \u2014 7-Day Comparison"]
  ];
...
function AgentAnalytics({ agents, generatedAt, removed }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_renderer2.View, { style: S.row2, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DonutBlock, { title: "Agent Connection Status", data: a.statusData, colors: palette(a.statusData), half: true })
    ] }),
